...
;// CONCATENATED MODULE: ./src/assets/js/lib/app.js
...
// EXTERNAL MODULE: ./node_modules/venobox/dist/venobox.min.js
var venobox_min = __webpack_require__(868);
var venobox_min_default = /*#__PURE__*/__webpack_require__.n(venobox_min);
;// CONCATENATED MODULE: ./src/assets/js/lib/modal.js

/* harmony default export */ function modal() {
  /* ==============================
    venobox
  ============================== */
  new (venobox_min_default())({
    selector: ".js-modal",
    infinigall: true,
    numeratio: true,
    maxWidth: "600px",
...
;// CONCATENATED MODULE: ./src/assets/js/lib/scroll.js


gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);

/* harmony default export */ function lib_scroll() {
  gsapWithCSS.config({
...
-----------------------------------------------------*/
  ...
  fadesTop01.forEach((fadeTop01) => {
    gsapWithCSS.effects.scrollAnim(fadeTop01, { start: "top 85%" });
  });
